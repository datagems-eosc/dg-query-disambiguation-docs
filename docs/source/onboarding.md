...
```bash
curl https://datagems-dev.scayle.es/health
```
...
- Swagger UI: https://datagems-dev.scayle.es/dg-query-disambiguation/swagger
- ReDoc: https://datagems-dev.scayle.es/dg-query-disambiguation/redoc
